...
namespace Missile_Command
{
    public class Prefabs
    {
        ...
        public static StructurePrefab[] statics = new StructurePrefab[]
            {Dot, Block, Beehive};
        public static StructurePrefab[] bigStatics = new StructurePrefab[]
            {Loaf, Boat, Ship, Fishook, Integral};
        public static StructurePrefab[] oscillators = new StructurePrefab[]
            {Blinker, Toad, Beacon, Clock, Cross, Fumarole, Galaxy, Pulsar, Pentadecathlon};
        public static StructurePrefab[] spaceships = new StructurePrefab[]
            {Glider, LWSS, GliderGun };
